package dotest.module.do_RongCloud.debug;
...
public class DoService {
	...
	public static void asyncMethod(DoModule _module, String _methodName, Map<String, Object> _paras, EventCallBack _eventCallBack) {
		try {
			JSONObject _jsonPara = new JSONObject();
			if (_paras != null) {
				for (String _key : _paras.keySet()) {
